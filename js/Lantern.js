...
function generateLights(camera,scene,renderer,num){
	...
	for(var i = 0; i < 20; i++){
		...
		var t_lanternGlow = new THREE.Mesh( lanternGlowGeo.clone(), shaderMaterial.clone());
