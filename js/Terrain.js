...
function Terrain(scene) {
	...
	// // var z = Math.random() * 100, perlin = new ImprovedNoise(), 
	// var t = 0;
	...
	// 	var data = generateHeightMap(width, height,10);
	...
	var init = function() {
		...
		mesh = that.mesh = new THREE.Mesh(geometry, new THREE.MeshPhongMaterial({ color: 0xffffff, specular: 0xffffff, shininess: 0, shading: THREE.SmoothShading, wireframe:false}) );
